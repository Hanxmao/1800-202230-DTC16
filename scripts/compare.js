...
function selectHandler(){
    ...
    $('#cardtype1').change(() => {
        ...
        //read the data from documents in credit_card collection that name field same as cardName1
    ...
    $('#cardtype2').change(() => {
        ...
        //read the data from documents in credit_card collection that name field same as cardName2
