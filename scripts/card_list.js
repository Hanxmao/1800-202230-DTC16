...
function displayCards(collection) {
    ...
    if (type == "travel") {
        ...
        db.collection(collection).where("category", "==", "cash_back").get()
        .then(snap => {
            snap.forEach(doc => {
                var title = doc.data().name;
                var description = doc.data().description;
    ...
    else if (type == "low_interest") {
        db.collection(collection).where("category", "==", "low_interest").get()
        .then(snap => {
            snap.forEach(doc => {
                var title = doc.data().name;
                var description = doc.data().description;
        ...
        db.collection(collection).where("category", "==", "student").get()
        .then(snap => {
            snap.forEach(doc => {
                var title = doc.data().name;
                var description = doc.data().description;
        ...
        db.collection(collection).where("category", "==", "business").get()
        .then(snap => {
            snap.forEach(doc => {
                var title = doc.data().name;
                var description = doc.data().description;
